...
const StatsBanner = () => (
  <div className="py-10 px-5 sm:py-14 sm:px-6 lg:py-16 bg-white border-y border-gray-100">
      ...
      {stats.map((s, i) => {
        ...
        return (
          <div key={i} className="text-center">
            ...
            <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 tracking-tighter">{s.value}</div>
